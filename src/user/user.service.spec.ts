...
describe('UserService', () => {
  ...
  beforeAll(async () => {
    ...
    jest.spyOn(mailerService, "sendMail").mockImplementation(async (mailOptions: MailOptions) => {
  ...
  it("Should register user", async () => {
    ...
    expect(userRepo.findOne({ where: { email: registerEmail, name: registerName } })).toBeTruthy();
  })
  ...
  it("Should generate unique verification token", () => {
    expect(userService.createVerificationToken() === userService.createVerificationToken()).toBeFalsy();
  })
  ...
  it("Should send verification email", async () => {
    await userService.sendVerificationEmail("name", "email@email", "token", "link");
